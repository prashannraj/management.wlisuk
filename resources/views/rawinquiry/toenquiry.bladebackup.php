                  ...
                  <div class="form-group row border-bottom-1">
                    ...
                    <div class="col-9">
                      <select class="form-control" id="mobile_title" name="country_id">
                        <option value="">Select Options</option>
                        @foreach ($data['country_code'] as $countryCode)
                        <option value="{{ $countryCode->id }}" {{ $countryCode->id==$data['row']->country_id ? 'selected':'' }}>{{ $countryCode->title }}</option>
                        @endforeach
                      </select>
                      {!! isError($errors, 'country_id') !!}
                      <input autocomplete="off" type="text" class="form-control mt-3" name="address" id="address" placeholder="Address" value="{{ $data['row']->address }}">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="note" rows="5" name="note">{!! ($data['row']->additional_details) ?? '' !!}</textarea>
                      {!! isError($errors, 'note') !!}
