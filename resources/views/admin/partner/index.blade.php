    ...
    <div class="col">
        ...
        <div class="card" id="documentCard">
            <div class="card-header">
                <h3 class="text-primary font-weight-600">Partners
                ...
                <div>
                        <form class="form-inline my-4" id="filterform">
                            <div class="form-group mx-2">
                                ...
                                <select autocomplete="off" type="text" class="ml-1 form-control" name="country_id">
                            ...
                            <div class="form-group mx-2">
                                ...
                                <select autocomplete="off" type="text" 
                                 class='ml-1 form-control' name="status">
...
<script>
    $(function() {
        ...
        var oTable = window.LaravelDataTables["partner-table"].draw();
