...
@include('partials.page_number')
    ...
    <h2>
        Applicant Declaration</h2>
    <p><br></p>
    <p style="margin-bottom: 0in; line-height: 100%">
        I, <b>{{$data['client_name']}}</b>, d.o.b.
        {{$data['client']->dob_format("d F Y")}} of {{$data['client_address']}} <span style="font-size:medium;font-weight: bold;">DO SOLEMNLY AND SINCERELY DECLARE</span> as
        follows:
    </p>
    ...
    <p style="line-height: 108%">
        ...
        {{$data['client_name']}}
        <br>
        Mobile/Tel: <b>{{$data['client_contact']}}</b>
        <br>
        Email: <b>{{$data['client_email']}}</b>
        <br />
        Date: <b>{{$data['date']}}</b>
    </p>
