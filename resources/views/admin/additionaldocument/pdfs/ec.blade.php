...
@include('partials.page_number')
    ...
    <p style="text-decoration:underline;font-weight:bold;text-align:center">RE: Employment Confirmation</p>
    <br><br>
    @if($data['content'] == null)
        @include('admin.additionaldocument.ec.content')
    @else 
    {!! $data['content'] !!}
    @endif
    <p>Yours sincerely,</p>
                ...
                <td>
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    @if($data['letter_signer']->signature)
                            ...
                            <tr>
                                <td>{{optional($data['letter_signer']->current_employment_info)->job_title}}</td>
                            </tr>
                        </tbody>
                    </table>
                </td>
