        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">View visa detail</h6>
                </div>
                ...
                <div id="">
                    <div class="card">
                        <div class="card-header">
                            <h4>Showing current visa detail of {{$data['row']->employee->full_name}}
                        ...
                        <div class="card-body">
                            <div class="address_details_error"></div>
                                ...
                                @include("admin.visa.form",["visa"=>$data['row'],"disabled"=>"disabled"])
