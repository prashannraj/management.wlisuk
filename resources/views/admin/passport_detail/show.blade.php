        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">View passport detail</h6>
                </div>
                ...
                <div id="">
                    <div class="card">
                        <div class="card-header">
                            <h4>Show passport Contact Detail
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('passportdetail.update', $data['row']->id) }}" method="POST">
                                ...
                                @include("admin.passport_detail.form",["passport"=>$data['row'],"disabled"=>"disabled"])
