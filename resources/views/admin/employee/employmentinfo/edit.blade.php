    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Editing employment information for {{$data['row']->employee->full_name}}</h6>
        </div>
...
<div class="row">
  <div class="col">
    <div class="card">
      <!-- Card header -->
      <div class="card-body">
        <form  action="{{ route('employmentinfo.update',$data['row']->id) }}" method="POST">
          @csrf
          @method('PUT')
        <div class="row">
