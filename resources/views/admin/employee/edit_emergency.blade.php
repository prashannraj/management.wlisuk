    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Edit employee emergency contact</h6>
        </div>
        ...
        <div id="AddressContactDetailAddForm">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('employeeemergency.update', $data['row']->id) }}" method="POST">
                        @csrf
                        @method('PUT')
