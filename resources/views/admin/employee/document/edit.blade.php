        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Editing document</h6>
                </div>
                ...
                <div id="">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('employeedocument.update', $data['row']->id) }}" enctype="multipart/form-data" method="POST">
                                @csrf
                                @method('PUT')
                                <input value="{{ $data['row']->employee_id }}" name="employee_id" type="hidden">
                                @include("admin.employee.document.form",["document"=>$data['row']])
