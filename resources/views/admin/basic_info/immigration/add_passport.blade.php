        ...
        <div id="AddressContactDetailAddForm">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('client.store.passport') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="iso_countrylist_id" name="iso_countrylist_id">
                                        ...
                                        @foreach ($data['country_code'] as $countryCode)
                                            <option value="{{ $countryCode->id }} " {{ (old('iso_countrylist_id') && old('iso_countrylist_id') == $countryCode->id)? 'selected':'' }} >{{ $countryCode->title }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" name="passport_number" id="passport_number" placeholder="Passport Number" value="{{ old('passport_number') }}">
                        ...
                        <div class="row">
                          <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" name="birth_place" id="birth_place" placeholder="" value="{{ old('birth_place') }}">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" name="issuing_authority" id="issuing_authority" placeholder="" value="{{ old('issuing_authority') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" name="citizenship_number" id="citizenship_number" placeholder="" value="{{ old('citizenship_number') }}">
