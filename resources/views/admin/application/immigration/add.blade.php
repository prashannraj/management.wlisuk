        ...
        <div id="CurrentVisaDetailAddForm">
          <div class="card">
            <div class="card-header">
              <h4>Add Client Immigration Application
                <a href="{{ route('client.show', $data['row']->id) }}" class="btn btn-sm btn-primary float-right"> Back</a>
              </h4>
            </div>
            <div class="card-body">
              <div class="documents_error"></div>
              <form action="{{ route('client.store.application.immigration') }}" method="POST" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="application_method" name="application_method">
                        ...
                        <option @if(old('application_method')=="paper" ) selected='selected' @endif v value="paper">Paper</option>
                        <option @if(old('application_method')=="email" ) selected='selected' @endif v value="email">Email</option>
                      </select>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input autocomplete="off" class="form-control" name="ref" id="ref" placeholder="Application Ref" value="{{ old('ref') }}">
                      {!! isError($errors, 'ref') !!}
                    </div>
                  </div>
