        ...
        <div id="DocumentAddForm">
          <div class="card">
            <div class="card-header">
              <h4>Edit Immigration Appeal Application
            ...
            <div class="card-body">
              ...
              <form action="{{ route('client.update.immigration-appeal', $data['row']->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="application_type" name="application_type">
                        <option value="">Select Options</option>
                        <option value="in-country"  {{ ($data['row']->application_type == 'in-country') ? 'selected' : ''  }}>In-country</option>
                        <option value="out-of-country"  {{ ($data['row']->application_type == 'out-of-country') ? 'selected' : ''  }}>Out of Country</option>
                      </select>
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <select class="form-control" id="application_method" name="application_method">
                        ...
                        <option value="post" {{ ($data['row']->application_method == 'post') ? 'selected' : ''  }}>Post</option>
                        <option value="in-person" {{ ($data['row']->application_method == 'in-person') ? 'selected' : ''  }}>In Person</option>
                      </select>
                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <input autocomplete="off" class="form-control" name="ref" id="ref" placeholder="Appeal Reference no:" value="{{ $data['row']->ref }}">
                      {!! isError($errors, 'ref') !!}
                    </div>
                  </div>
