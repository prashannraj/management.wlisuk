        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                ...
                <div class="col-lg-6 col-5 text-right">
                    <a href="{{ route('client.list.immigration-appeal.logs',$data['application_id']) }}" class="btn btn-sm btn-neutral">
...
<div class="card" id="documentCard">
    <div class="card-header">
        <h4 class="text-primary font-weight-600">Application Process of {{$data['applicationProcess']->application->student_name}}
          <a href="{{ route('client.list.immigration-appeal.logs', $data['applicationProcess']->application_id) }}" class="btn btn-sm btn-primary float-right"> Back</a>
