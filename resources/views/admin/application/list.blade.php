<div class="card" id="documentCard">
    <div class="card-header">
        <h4 class="text-primary font-weight-600">Immigration Applications</h4>
    </div>
    <div class="card-body">
            ...
            <table class="table table-border table-striped" id="documentTable">
                ...
                <tbody class="document_details">
                    ...
                    <tr>
                        ...
                        <td> {{ $immapp->status->title }} </td>
                        <td>
                            <a href="{{ route('client.edit.application.immigrationappeal',$immapp->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                            <a href="{{ route('client.list.immigration-appeal.logs',$immapp->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-cog"></i></a>
