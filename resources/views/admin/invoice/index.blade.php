    ...
    <div class="card" id="documentCard">
      <div class="card-header">
        <h3 class="text-primary font-weight-600">Invoices
          <a href="{{ route('finance.invoice.create') }}" class="btn btn-sm btn-primary float-right" id="addBtnDocument">
            <span class="d-sm-block d-md-none"> <i class="fas fa-plus"></i></span>
            <span class="d-none d-md-block d-lg-block"> <i class="fas fa-plus"></i> Create new invoice </span>
          </a>
        </h3>
      </div>
      <div class="card-body">
      ...
      <div class="card-footer">
        <a href="{{ route('finance.invoice.create') }}" class="btn btn-sm btn-primary" id="addBtnDocument">
...
<div id="delete_documen" class='modal fade'>
...
<script>
  $(function() {
    var oTable = $('#invoice_table').DataTable({
      ...
      ajax: {
        url: '{!! route("finance.invoice.index") !!}',
        data: function(d) {
