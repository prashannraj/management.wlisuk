...
@endif
                            ...
                            <!-- Original Table for Full Name -->
                            <div style="width: 96.2387%;">
                                <p style="text-align: center; vertical-align: bottom;">{{ $data['enquiry']->full_name_with_title }}</p>
                                <div style="width: 90%; height: 1px; background-color: black; margin: 4px auto;">&nbsp;</div>
                                <p style="text-align: center;">Your Name</p>
                                <p style="text-align: center;">Your Signature</p>
                                <p style="text-align: center;">Date</p>
                            </div>

                            <!-- Display Added Names as a List -->
                            @php
...
@push('scripts')
    ...
    <script>
        document.getElementById('saveButton').addEventListener('click', function() {
            ...
            fetch(`/enquiry/clientcare/${enquiryId}/save`, {
                    method: 'POST',
                    headers: {
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#loadButton').click(function(e) {
                ...
                $.ajax({
                    url: '{{ route('load.clientcare', ':id') }}'.replace(':id', enquiryId),
                    method: 'GET',
