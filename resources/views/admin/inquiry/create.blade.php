                  ...
                  <div class="form-group row border-bottom-1">
                    ...
                    <div class="col-9">
                      <select class="form-control" id="mobile_title" name="country_id">
                        <option value="">Select Options</option>
                        @foreach ($data['country_code'] as $countryCode)
                        <option value="{{ $countryCode->id }}" {{ $countryCode->id==old('country_id') ? 'selected':'' }}>{{ $countryCode->title }}</option>
                        @endforeach
                      </select>
                      {!! isError($errors, 'country_id',"This field is required") !!}
                      <input autocomplete="off" type="text" class="form-control mt-3" name="address" id="address" placeholder="Address" value="{{ old('address') }}">
                      {!! isError($errors, 'address') !!}

                      <input autocomplete="off" type="text" class="form-control mt-3" name="postal_code" id="postal_code" placeholder="Postal Code" value="{{ old('postal_code') }}">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-12">
                      <textarea class="form-control" id="note" rows="5" name="note">{{old('note')}}</textarea>
                      {!! isError($errors, 'note') !!}
                    </div>
                  </div>
