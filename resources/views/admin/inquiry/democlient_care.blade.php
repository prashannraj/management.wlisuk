                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <p id="fullNameDisplay">{{ $data['enquiry']->full_name_with_title }}</p>
                            <input type="text" id="nameField" class="form-control"
                                value="{{ $data['enquiry']->full_name_with_title }}">
                            <input type="hidden" id="added_names_input" name="added_names_input" value='[]'>
                    ...
                    <div class="col-md-12"> <!-- Full width for new textarea -->
                        <div class="form-group">
                            <label for="">Discussion Details:</label>
                            <textarea id="additional_notes" name="additional_notes" class='form-control wysiwyg' rows='2'
                                placeholder="Enter any additional notes here..."
                                value="{{ old('additional_notes', optional($data['clientcare'])->additional_notes) }}"></textarea>
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <p style="margin-bottom: 0.14in; line-height: 120%;" align="justify"><span style="font-family: 'Courier New', Courier, monospace;">My name is {{ $data['advisor']->name }} and I will be handling your case. I am authorised to provide immigration advice and services at <strong>{{ $data['advisor']->level }}</strong> in the categories of <strong>{{ $data['advisor']->category }}.</strong></span></p>
                            ...
                            <p style="margin-bottom: 0.14in; line-height: 120%;" align="justify"><span style="font-family: 'Courier New', Courier, monospace;">We are based at,</span> <span style="font-family: 'Courier New', Courier, monospace;">{{ $data['company_info']->address }}. The normal hours of work are from 10 am to 5 pm Monday to Friday.</span></p>
                            ...
                            <p style="margin-bottom: 0.14in; line-height: 120%;" align="justify"><span style="font-family: 'Courier New', Courier, monospace;">My emergency number is {{ $data['advisor']->contact }}. Please only use in an urgent situation.</span></p>
                            ...
                            <p style="margin-bottom: 0.14in; line-height: 120%;" align="center"><span style="font-family: 'Courier New', Courier, monospace;"><strong>{!! $data['bank']->bank_details() !!}</strong></span> <span style="font-family: 'Courier New', Courier, monospace;"><strong>{!! 'Payment reference: ENQ' . $data['enquiry_id'] !!}</strong></span></p>
                            ...
                            <tbody>
                            <tr>
                            <td><img style="height: auto;" src="{{ public_path($data['advisor']->signature_url) }}" alt="" width="120" /></td>
                            </tr>
                            <tr>
