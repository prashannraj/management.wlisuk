...
<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <form id="form_loa" action="{{ route('enquiry.letterofauthority', $data['enquiry']->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                         ...
                         <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="date" id="date" class="form-control datepicker2" value="{{ old('date', \Carbon\Carbon::parse(optional($data['letterofauthority'])->date)->format('d/m/Y')) }}" required>
                                {!! isError($errors, 'date') !!}
                            </div>
                        </div>
                        ...
                        <div class='col-md-6'>
                            <div class="form-group">
                                ...
                                <input type="text" name="client_name" class="form-control"
                                    value="{{ old('client_name', optional($data['letterofauthority'])->client_name) }}">
                        ...
                        <div class='col-md-6'>
                            <div class="form-group">
                                ...
                                <input type="text" name="date_of_birth" id="date_of_birth" class="form-control datepicker2"
                                    value="{{ old('date_of_birth', optional($data['letterofauthority'])->date_of_birth ? \Carbon\Carbon::parse($data['letterofauthority']->date_of_birth)->format('d/m/Y') : '') }}" placeholder="dd/mm/yyyy">
                            ...
                            <div class="form-group">
                                ...
                                <select name="advisor_id" class="form-control">
                                    ...
                                    @foreach ($data['advisors'] as $advisor)
                                        <option
                                            {{ old('advisor_id', optional($data['letterofauthority'])->advisor_id) == $advisor->id ? 'selected' : '' }}
                        ...
                        <div class="col-md-12 mt-4">
                            <div class="form-group">
                                ...
                                <textarea name="content" id="content_loa" cols="30" rows="10" class="wysiwyg">
                                    ...
                                    <td style="border: 1px solid #000000; padding: 0in 0.08in;" width="100%">
                                        <p><strong>
                                            {{ \Carbon\Carbon::parse(old('date_of_birth', $data['letterofauthority']->date_of_birth ?? ''))->format('d M Y') }}
                                        </strong></p>
                                    </td>
                                    </tr>
                                    <tr valign="top">
