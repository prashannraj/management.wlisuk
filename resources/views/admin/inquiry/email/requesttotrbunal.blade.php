...
<p>
    Attached, please find a completed request for the tribunal determination letter. Kindly ensure it is signed by 
    <strong>{{ optional($data['requesttotrbunal'])->appellant_name ?? '' }}</strong> and email the signed document back to us.
</p>
<p>
