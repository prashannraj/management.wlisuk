...
@include('partials.page_number')
    ...
    <table style="border:1px">
        <tbody>
            <tr>
                <td width="100%">
                  <b>  I request that you use reference number ENQ{{$data['enquiry']->id}} when emailing them.</b>
    ...
    <table style="border:1px">
        <tbody>
            <tr>
                <td width="100%">
                  <b> Additionally, I authorise {{$data['company_info']->name}} to communicate with my previous representatives, IAC, the Home Office, HMRC,
                     and the Data Protection Unit to obtain all necessary information, records, and documentary evidence.</b>
                </td>
            </tr>
        </tbody>
    </table>
...
<table style="width:100%">
                    ...
                    <table>
                        <tbody>
                            <tr>
                                ...
                                <td style='width: 100%;'>
                                    <p><b>{{ \Carbon\Carbon::parse(old('date', $data['letterofauthority']->date ?? ''))->format('d/m/Y') }}</b>
                                    </p>
    ...
    Please treat this letter as an application under the Data Protection Act 2018.
    </div>
