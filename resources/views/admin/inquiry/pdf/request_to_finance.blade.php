...
@include('partials.page_number')
    ...
    <h3 align="center" style="text-transform:uppercase;color:#4f81bd;text-align:center;font-weight:bold;font-size:20px">
        Request Acess to Financial Records
    </h3>
    ...
    <p align="left" style="color:#030303;text-align:left;font-size:20px">
      Date: <strong>{{ \Carbon\Carbon::parse(old('date', $data['requesttofinance']->date ?? ''))->format('d M Y') }}<br>
    </p>
    <p align="left" style="color:#030303;text-align:left;font-size:20px">
      Agency: <strong>{!! isset($data['agency']) ? $data['agency'] : '<b>Content is missing.</b>' !!}</strong>
    </p>
