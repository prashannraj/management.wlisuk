    ...
    <div class="header-body">
      <div class="row align-items-center py-4">
        <div class="col-lg-6 col-7">
          <h6 class="h2 text-white d-inline-block mb-0">Create New Receipt</h6>
        </div>
...
<div class="row">
  <div class="col">
    <div class="card">
      ...
      <div class="card-body">
        <form class="row" action="{{ route('finance.receipt.store' )}}" method="POST" enctype="multipart/form-data">
          @csrf
          @if(request()->from_client)
