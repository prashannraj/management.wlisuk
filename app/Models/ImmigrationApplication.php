...
class ImmigrationApplication extends Model
{
    protected $table = 'immigration_applications';
    ...
    {
        return $this->hasMany(ImmigrationApplicationProcess::class, 'application_id', 'id');
    }
