...
class ImmigrationApplicationProcessMail extends Mailable
{
    ...
    public function application_submitted()
    {
        ...
        // $pdf ;
        $pdf = PDF::loadView('admin.application.immigration.log.pdf.application_submitted', compact('data'));
        ...
        $initial->view('admin.application.immigration.emails.application_submitted', compact('data'));
        ...
        $email_content = $description .= "<br><br><br>" . view('admin.application.immigration.emails.application_submitted', compact('data'));
        //creating email log
    ...
    public function generic_process(){
        ...
        $initial->view('admin.application.immigration.emails.generic_mail', compact('data'));
        ...
        $description .= "<br><br>";
        $description .= "Attachments: " . $attachments;
        $email_content = $description .= "<br><br><br>" . view('admin.application.immigration.emails.generic_mail', compact('data'));
        //creating email log
        CommunicationLog::create([
            'to' => $data['application_process']->application->client->full_name,
    ...
    public function file_closed(){
		...
		$initial->attachFromStorageDisk('uploads', $filepath,$client->id . '_File_Closed_'.$client_name.'.pdf');
        // $initial->attachData($pdf->stream(), $client->id . '_Application_Submitted.pdf');
        $attachments = $client->id . '_File_Closed_'.$client_name.'pdf';
        $document = $data['application_process']->document;
        if ($document) {
            $initial->attachFromStorageDisk('uploads', $document);
            $attachments .= ", " . $document;
        ...
        $initial->view('admin.application.immigration.emails.file_closed', compact('data'));
        ...
        $description .= "<br><br>";
        $description .= "Attachments: " . $attachments;
        $email_content = $description .= "<br><br><br>" . view('admin.application.immigration.emails.file_closed', compact('data'));
        //creating email log
        CommunicationLog::create([
            'to' => $data['application_process']->application->client->full_name,
