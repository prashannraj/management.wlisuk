...
class CoaMail extends Mailable
{
    ...
    public function build()
    {
        ...
        // Email body and log
        $email_content = view('admin.inquiry.email.clientofauthority', compact('data'))->render();
    ...
    public function createDocument($filename)
    {
        ...
        $path = public_path('uploads/files/clientofauthority');
        ...
        $db = "/clientofauthority/" . $file_name;
        $data = $this->data;
