...
class RttMail extends Mailable
{
    ...
    public function build()
    {
        ...
        CommunicationLog::create([
            'to'            => $data['requesttotrbunal']->client_name ?? 'Unknown',
            'description'   => "Request To Tribunal Determination",
        ...
        return $this->from(getEmailSender(3)->email, getEmailSender(3)->name)
            ->to(getEmailSender(3)->email, getEmailSender(3)->name)
            ->replyTo(
