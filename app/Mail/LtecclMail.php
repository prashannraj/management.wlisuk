...
class LtecclMail extends Mailable
{
    ...
    public function build()
    {
        ...
        $subject = "Att: ENQ{$data['enquiry']->id} - {$data['lteccl']->full_name_with_title} - Client Care Letter Appeal - Gurkha - Child (LTE)";
        ...
        // Email body and log
        $email_content = view('admin.inquiry.email.clientcare', compact('data'))->render();

        CommunicationLog::create([
            'to' => $data['lteccl']->full_name_with_title,
            'description' => "Client Care Letter Appeal Gurkha Child (LTE)",
    ...
    public function createDocument($filename)
    {
        ...
        $path = public_path('uploads/files/lteccl');
